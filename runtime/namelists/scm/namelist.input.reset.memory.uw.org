 ...
 &rce_control
 vcord_opt                           = 1
 relax_t_strato_flag                 = .false.
 t_strato_target                     = 200
 tau_relax_t_strato                  = 10800
 relax_t_qv_strato_flag              = .true.
 relax_uv_flag                       = .true.
 u_target                            = 0.0
 v_target                            = 0.0
 ...
 &record_vars_control
 record_vars_flag                    = .false.
 record_timestep                     = 720001
 /
 ...
 &reset_memory_control
 reset_memory_flag                   = .true.
 reset_memory_timestep               = 720721
 /
